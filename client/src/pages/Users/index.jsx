...
const TABLE_HEAD = [
	...
	{ id: 'englishLevel', label: 'English Level', alignRight: false },
	{ id: 'resumeLink', label: 'Resume', alignRight: false },
...
export default function Users() {
	...
	const handleSelectAllClick = (event) => {
		if (event.target.checked && users.length > 0) {
											...
											.map((row, index) => {
												...
												return (
													...
													>
														...
														<TableCell align="left">{englishLevel}</TableCell>
														<TableCell align="left">
															<Link href="#">{resumeLink}</Link>
														</TableCell>
														<TableCell align="left">
															{status && (
																<Label
